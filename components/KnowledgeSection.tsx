...
import { KNOWLEDGE_DATA } from "../data/mockData";
import {
...
export const KnowledgeSection = () => {
  ...
  const filteredSkills = KNOWLEDGE_DATA.filter(skill =>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="p-4 rounded-2xl bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-blue-600 shadow-inner group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                    <Icon size={24} />
                  </div>
                  <div>
