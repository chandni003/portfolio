      ...
      <section className="pt-32 pb-16 px-4 text-center">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-black tracking-tight mb-8 leading-tight">
            The Steps Of <br />
            <span className="text-blue-600 italic">Progress.</span>
          </h1>
        </div>
      </section>
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-10 items-start">
                <div className="flex flex-col items-center md:items-start gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2 px-4 py-1.5 bg-blue-500/10 rounded-full border border-blue-500/20 text-blue-600 font-black text-[10px] uppercase tracking-widest whitespace-nowrap">
                      <Calendar size={12} />
                      {exp.period}
                    </div>
